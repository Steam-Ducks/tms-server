...
import org.example.tmsserver.entity.RegionIndicatorId;
...
@Repository
public interface RegionIndicatorRepository extends JpaRepository<RegionIndicator, RegionIndicatorId> {
